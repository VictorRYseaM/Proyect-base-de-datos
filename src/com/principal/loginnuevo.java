...
public class loginnuevo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Historial Médico");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 500, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/Aprendizaje_experimental (1).png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -5, 490, 450));
        ...
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 0, 40, 30));
        ...
        btninisesion.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btninisesion.setForeground(new java.awt.Color(25, 118, 211));
        btninisesion.setText("INICIAR SESIÓN");
        ...
        jPanel2.add(btninisesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(34, 306, 341, 40));
        ...
        jLabel14.setText("Sin cuenta de acceso?");
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        ...
        registernuevo rgs = new registernuevo();
        rgs.setVisible(true);
        rgs.pack();
    ...
    private void btninisesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btninisesionActionPerformed
        ...
        try {
            ...
            if (txtusername.getText().isBlank()) {
                ...
                sql = "SELECT * FROM inicio WHERE correo=?";
                ...
                if (rs.next()) {
                    ...
                    if (contra.equals(contradb)) {
                        ...
                        JOptionPane.showMessageDialog(null, "Contraseña Incorrecta", "Datos incorrectos", JOptionPane.ERROR_MESSAGE);
                        txtpassword.setText("");
                    }
                } else {
                    JOptionPane.showMessageDialog(null, "Datos de Inicio Incorrectos", "Datos incorrectos", JOptionPane.ERROR_MESSAGE);
                    txtpassword.setText("");
                    txtusername.setText("");
                }
            }
